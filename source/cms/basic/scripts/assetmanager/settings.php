...
global $MaxFileSize;		$MaxFileSize = ($size ? $size : 3000000);

global $AllowedTypes;		$AllowedTypes = "*";
...
global $sBase0;			$sBase0 = BASIC::init()->ini_get('root_path').BASIC::init()->ini_get('upload_path').'demos';
