...
interface ModuleSettingsInterface{
	...
	/**
	 * system will execute this method after component's registration
	 *
	 * @param boolean check 
	 * @return boolean
	 */
...
//				}
		...
		if(method_exists($this->module_build, 'prepareCofiguration') && $this->module_build->prepareCofiguration(true)){
