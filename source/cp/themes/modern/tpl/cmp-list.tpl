...
<div class="filtertab filterhide"><span>&nbsp;</span></div>
<div class="tools htools">
	<div class="actions">
...
<div class="list">
	<table class="list_grid" border="0" cellspacing="1" cellpadding="0">
		<tr class="theader">
			<!-- if(${use_order}) --><td class="resetorder"><a href="${use_order}">&nbsp;</a></td><!-- end -->
			<td class="selectable">
				<!-- if(${use_checkbox}) --><input type="checkbox" onclick="managerList.changeAll(this);" value="${cmd}"/><!-- end -->
			</td>
			<!-- foreach(${headers},head) -->
			<td ${head.attr}>${head.label}<!-- if(${head.selected}) --><span class="sort sort<!-- if(${head.isdown}) -->down<!-- else -->up<!-- end -->">&nbsp;</span><!-- end --></td>
			<!-- end -->
		</tr>
		<tr lang="0" class="space_row">
		...
		<tr lang="${row.id}" class="row<!-- if(!${row.row_level}) --> firstlevel<!-- end --><!-- if(${row.even_class}) --> even<!-- else --> odd<!-- end -->">
		...
		<tr lang="${row.id}" class="space_row">
			<!-- if(${use_order}) --><td></td><!-- end -->
			<td></td>
