...
if(!BASIC_USERS::init()->getPermission($assetManager->model->system_name, 'folders-manager')){
...
<script>
	...
	document.write("<scr"+"ipt src='<?php print $root_manager_virtual; ?>language/"+sLang+"/foldernew.js'></scr"+"ipt>");
</script>
